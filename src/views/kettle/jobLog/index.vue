<template>
  <div class="app-container">
    <el-form :model="queryParams" ref="queryForm" :inline="true" v-show="showSearch" label-width="68px">
      <el-form-item label="作业名称" prop="transName">
        <el-input
    ...
    <el-row :gutter="10" class="mb8">
      <el-col :span="1.5">
        <el-button
          ...
          :disabled="multiple"
          @click="handleDelete"
          v-hasPermi="['kettle:jobLog:remove']"
        >删除</el-button>
      </el-col>
      <el-col :span="1.5">
        <el-button
      ...
      <el-col :span="1.5">
        <el-button
          ...
          size="mini"
          @click="handleExport"
          v-hasPermi="['kettle:jobLog:export']"
        >导出</el-button>
      </el-col>
    ...
    <el-table v-loading="loading" :data="jobLogList" @selection-change="handleSelectionChange">
      ...
      <el-table-column label="作业日志ID" align="center" prop="jobLogId" />
...
<!--      <el-table-column label="耗时" align="center" prop="consumingTime" />-->
...
<!--      <el-table-column label="异常信息" align="center" prop="exceptionInfo" />-->
      <el-table-column label="操作" align="center" class-name="small-padding fixed-width">
        <template slot-scope="scope">
          <el-button
            ...
            v-hasPermi="['kettle:jobLog:query']"
          >详细</el-button>
        </template>
      </el-table-column>
    </el-table>
    ...
    <!-- 作业执行日志详细 -->
    <el-dialog title="作业执行日志详细" :visible.sync="open" width="1000px" append-to-body>
      <el-form ref="form" :model="form" label-width="100px" size="mini">
        <el-row>
          <el-col :span="15">
            <el-form-item label="作业ID：">{{ form.jobId }}</el-form-item>
...
<script>
import { listJobLog, getJobLog, delJobLog, cleanJobLog, addJobLog, updateJobLog, exportJobLog } from "@/api/kettle/jobLog";
...
export default {
  ...
  methods: {
    ...
    handleDelete(row) {
      ...
      this.$confirm('是否确认删除作业执行日志编号为"' + jobLogIds + '"的数据项?', "警告", {
    ...
    handleExport() {
      ...
      this.$confirm('是否确认导出所有作业执行日志数据项?', "警告", {
          confirmButtonText: "确定",
          cancelButtonText: "取消",
          type: "warning"
        }).then(function() {
